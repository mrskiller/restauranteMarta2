...
public class ControladorServletCocinero extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ControladorServletCocineronero.class.getName()).log(Level.SEVERE, null, ex);
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(ControladorServletCocineroinero.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
